/**
 * Project Configuration for `@arts/license-pro`
 */
export default {
  ...
  repository: 'https://github.com/artkrsk/arts-license-pro',
  ...
  paths: {
    ...
    library: {
      base: 'libraries',
      name: 'arts-license-pro',
      assets: 'src/php/libraries/arts-license-pro'
    },
    aliases: {
      '@': './src/ts'
    }
  ...
  wordpressPlugin: {
    ...
    packageName: 'arts-license-pro',
    zipOutputName: 'arts-license-pro.zip',
    packageExclude: [
      'node_modules',
      '.git',
      '.DS_Store',
  ...
  i18n: {
    enabled: false,
    src: 'src/php/**/*.php',
    dest: 'src/wordpress-plugin/languages/arts-license-pro.pot',
    domain: 'arts-license-pro',
    package: 'Arts License Pro',
